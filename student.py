...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_label.grid(row=0,column=0,padx=6,pady=15)

        #combo box 
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,width=15,font=("verdana",12,"bold"),state="readonly")
        dep_combo["values"]=("Select Department","CSE","IT","E.Tc","ELECTRICAL","MECHANICAL","CIVIL")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=6,pady=15,sticky=W)
        ...
        cou_combo["values"]=("Select Course","CS","IT","EC","EE","ME","CE")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2018-22","2019-23","2020-24","2021-25","2026-30")
        ...
        #Student id
        # studentId_label = Label(class_Student_frame,text="Enrollment No.",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Full Name:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        # #Roll No
        student_roll_label = Label(class_Student_frame,text="Enrollment No.",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Phone Number
        search_label = Label(search_frame,text="Enrollment No.",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        # search_combo["values"]=("Select","Enrollment No")
        ...
        self.student_table.heading("Roll-No",text="Enrollment No.")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="":
            messagebox.showerror("Error","Please Fill All Fields are Required!",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(user='root', password='1947',host='localhost',database='face_recognition',port=3306)
                ...
                self.fetch_data()
                conn.close()
                capture_cam.capture_c(self.var_std_name.get(),self.var_roll.get())
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(user='root', password='1947',host='localhost',database='face_recognition',port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Email=%s,PhotoSample=%s where Roll_No=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Image Taken!",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due to: {str(es)}",parent=self.root) 
